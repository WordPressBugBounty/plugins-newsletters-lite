...
<div class="wrap newsletters about-wrap">
	...
	<div class="changelog newsletters-changelog">
		...
		<p><a href="https://tribulant.com" target="_blank"><img style="max-width: 300px; width: initial;" src="<?php echo esc_url_raw($this -> url()); ?>/images/logo.png" alt="tribulant" /></a></p>
