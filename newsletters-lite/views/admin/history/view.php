...
<div class="wrap newsletters <?php echo esc_html($this -> pre); ?> newsletters">
	...
	<div class="tablenav">
		<div class="alignleft actions">
            ...
            <a href="<?php esc_html_e(wp_nonce_url('?page=' . $this->sections->history . '&amp;method=delete&amp;id=' . $history->id, $this->sections->history . '_delete')); ?>"
               onclick="if (!confirm('<?php esc_html_e('Are you sure you want to delete this histtory email?', 'wp-mailinglist'); ?>')) { return false; }"
               class="submitdelete button button-highlighted">
                <i class='fa fa-times'></i><?php esc_html_e(__('Delete', 'wp-mailinglist')); ?>
            </a>
