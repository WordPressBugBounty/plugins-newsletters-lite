	...
	<tbody>
        ...
        <tr class="advanced-setting">
	        ...
	        <td>
		        ...
		        <span class="howto"><?php esc_html_e('Allow subscribers to set a password to log in to manage subscriptions in the future.', 'wp-mailinglist'); ?></span>
	        </td>
        </tr>
        <tr>
        ...
        <tr>
	        ...
	        <td>
				...
				<span class="howto"><?php esc_html_e('Display the lists that subscribers are subscribed to, allowing them to unsubscribe.', 'wp-mailinglist'); ?></span>
			</td>
        </tr>
        <tr>
	        <th><label for="managementshowprivate"><?php esc_html_e('Show Private Lists', 'wp-mailinglist'); ?></label></th>
	        <td>
		        <label><input <?php echo (!empty($managementshowprivate)) ? 'checked="checked"' : ''; ?> type="checkbox" name="managementshowprivate" value="1" id="managementshowprivate" /> <?php esc_html_e('Yes, show private lists on the front-end to all subscribers.', 'wp-mailinglist'); ?></label>
	        </td>
        </tr>
        <tr>
            ...
            <td>
            	...
            	<span class="howto"><?php esc_html_e('Should other, non-private lists be shown for subscribers to subscribe to? This setting controls if people managing their subscriptions are allowed to subscribe to more mailing lists while in the management section.', 'wp-mailinglist'); ?></span>
            </td>
        </tr>
        <tr>
